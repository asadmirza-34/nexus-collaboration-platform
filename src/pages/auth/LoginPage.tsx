          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            {step === 'credentials' ? (
              ...
              <div className="space-y-4">
                <div className="rounded-md border border-secondary-200 bg-secondary-50 px-4 py-3">
                  <p className="text-sm text-secondary-800">
                    Enter the 6-digit OTP sent to <span className="font-semibold">{email}</span>.
                  </p>
                  {generatedOtp && (
                    <p className="mt-1 text-xs text-secondary-700">
                      Mock OTP for demo: <span className="font-semibold tracking-wider">{generatedOtp}</span>
                    </p>
                  )}
                </div>
            ...
            >
              {step === 'credentials' ? 'Continue to OTP' : 'Verify OTP & Sign in'}
            </Button>
          </form>
