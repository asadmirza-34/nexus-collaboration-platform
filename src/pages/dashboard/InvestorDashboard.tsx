...
import { useSchedulingStore, getConfirmedMeetingsForUser } from '../../features/scheduling/store';
...
export const InvestorDashboard: React.FC = () => {
  ...
  const upcomingMeetingsCount = getConfirmedMeetingsForUser(scheduling.state, user.id).filter(
    m => new Date(m.end).getTime() > Date.now()
  ).length;
  const walletBalance = wallet.getBalance(user.id);
            ...
            <div className="flex items-center">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-end justify-between gap-3">
                  ...
                  <Link to="/schedule" className="text-sm font-medium text-primary-600 hover:text-primary-500">
                    Open
                  </Link>
                </div>
              </div>
              ...
              <div className="flex-1">
                ...
                <div className="flex items-end justify-between gap-3">
                  <h3 className="text-xl font-semibold text-secondary-900">
                    {walletBalance.toLocaleString(undefined, { style: 'currency', currency: 'USD' })}
                  </h3>
